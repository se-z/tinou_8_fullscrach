...
public class Converter {//自然言語の入力に対して、順序構造を表すクラスに変換する。
    ...
    ArrayList<Interm> getExIntermList(ArrayList<Interm> a_originList, ArrayList<Block2> a_blockList) {
    ...
    void setMatchList(ArrayList<String> a_List, ArrayList<Block2> a_blockList, String a_match) {
        for (Block2 block : a_blockList) {
    ...
    void readJSON(ArrayList<Integer> a_space, ArrayList<Block2> a_bList, ArrayList<String> a_oInputS) {
        try {
    ...
    //ブロックの情報からブロックリストを作る
    ArrayList<String> makeExObjList(ArrayList<Block2> a_blockList) {
        ArrayList<String> objList = new ArrayList<String>();
        for (Block2 a_block : a_blockList) {
    ...
    *自然言語からOrderに変換する 初代
    */
    ArrayList<Order> convToOrder1(ArrayList<String> a_inputS, ArrayList<Block2> a_blockList) {
    ...
    ArrayList<Order> convToOrder(ArrayList<String> a_inputS, ArrayList<Block2> a_blockList) {
